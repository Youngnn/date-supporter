...
exports.update = (req, res) => { 
  Device.findOneAndUpdate( {deviceId:req.params.deviceId}, 
    { deviceId: req.body.deviceId, name: req.body.name, spot: req.body.spot, link: req.body.link,  latitude: req.body.latitude, longitude: req.body.longitude, description: req.body.description }, 
    {new:true}
  )
  .then(contact => { 
    if(!contact) {
